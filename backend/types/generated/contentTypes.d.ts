...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    ...
    highlight_medias: Attribute.Media;
    seo: Attribute.Component<'shared.seo'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    typography: Attribute.Component<'project.typography', true>;
    colors: Attribute.Component<'project.color', true>;
    main_images: Attribute.Component<'project.project-main-image', true>;
...
export interface ApiShopsPageShopsPage extends Schema.SingleType {
  ...
  attributes: {
    title: Attribute.String;
    subtitle: Attribute.String;
    shops_list: Attribute.Component<'shops.shop-item', true>;
    social_links: Attribute.Component<'about.social-link', true>;
    seo: Attribute.Component<'shared.seo'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiSkillSkill extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<['language', 'development', 'art', 'web']>;
